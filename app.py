...
def fetch_poster(movie_id):
    response = requests.get('https://api.themoviedb.org/3/movie/{}?api_key=672c95d11266e7d347aa2ac2797e4848&language=en-US'.format(movie_id))
    data = response.json()
...
st.title("Welcome To My Movies Recommendation System")
